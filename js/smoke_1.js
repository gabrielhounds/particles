...
function init() {
	...
	for (var i = 0; i<xNum; i++) {
		blobs = $('<div class="smokeB"></div>').appendTo(wrapper);

		t.set(blobs, {x:random(window.innerWidth / 2 - 10, window.innerWidth / 2 + 10 ), y:window.innerHeight + 100, scaleX:random(2.0, 4.0), scaleY:random(3.0, 6.0), opacity:random(0.1, 0.5)});
